                  ...
                  <article class='product-card' data-category='$category'>
                    ...
                    <div class='product-body'>
                      ...
                      <div class='product-actions'>
                        <button onclick=\"addToCart('$id', null, 1, {name: '$jsName', price: " . $row['price'] . ", image: '$jsImage', category: '$jsCategory'}, '$jsAvailableType')\" class='btn-primary small' aria-label='Add to cart'>Add to Cart</button>
